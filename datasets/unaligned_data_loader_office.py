...
class UnalignedDataLoader():
    ...
    def initialize(self, source, target, batch_size1, batch_size2, scale=32, split='Train', shuffle_=True):
        start_first = 0
        ...
        for i in range(len(source)):
            ...
            data_loader_s.append(torch.utils.data.DataLoader(data_sources[i], batch_size=batch_size1, shuffle=shuffle_, num_workers=3))
        ...
        data_loader_t = torch.utils.data.DataLoader(dataset_target, batch_size=batch_size2, shuffle=shuffle_, num_workers=3)
