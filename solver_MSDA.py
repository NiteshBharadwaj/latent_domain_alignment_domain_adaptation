    ...
    def __init__(self, args, batch_size=64,
        ...
        if args.data == 'digits':
            if args.dl_type == 'original':
                ...
                self.datasets, self.dataset_test, self.dataset_valid, self.is_multi, self.usps_only = dataset_hard_cluster(target, self.batch_size, args.num_domain, args.office_directory, args.seed,
