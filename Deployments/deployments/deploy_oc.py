...
def generate_yaml(type, cmd, name, mem_limit, mem_req, node, ngpus, ssh_key, user):
    ...
    variables["UNZIP_CMD"] = "echo Unzipping; mkdir -p /localdata/office_caltech;mkdir -p /localdata/office_caltech/data; unzip /data/datasets/Office-Caltech10.zip  -d /localdata/office_caltech/data/;"
