...
def generate_yaml(type, cmd, name, mem_limit, mem_req, node, ngpus, ssh_key, user):
    ...
    variables["UNZIP_CMD"] = "echo Unzipping; mkdir -p /localdata/digits;mkdir -p /localdata/office/data/; unzip /data/code_MSDA_digit/Digit-Five.zip  -d /localdata/digits/;tar -xf /data/datasets/office.tar -C /localdata/office/data/"
